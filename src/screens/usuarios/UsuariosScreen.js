    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                <MaterialCommunityIcons name="account-group-outline" size={72} color={COLORS.success} />
...
const styles = StyleSheet.create({
    ...
    title:     { fontSize: 24, fontWeight: 'bold', color: COLORS.textDark, marginTop: 16, marginBottom: 8, textAlign: 'center' },
